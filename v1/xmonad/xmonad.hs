...
myWorkspaceBar    = "dzen2 -x '0' -y '784' -h '16' -w '956' -ta 'l' -fg '" ++ colorWhiteAlt ++ "' -bg '" ++ colorBlack ++ "' -fn '" ++ dzenFont ++ "' -p -e ''"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
	...
	, ((modMask .|. shiftMask, xK_o), restart "/home/nnoell/bin/obtoxmd.hs" True)
